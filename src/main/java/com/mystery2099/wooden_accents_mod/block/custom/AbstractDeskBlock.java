        ...
        switch (mirror) {
            case LEFT_RIGHT -> {
                ...
                return switch (stairShape) {
                    case LEFT -> state.rotate(BlockRotation.CLOCKWISE_180).with(SHAPE, DeskShape.RIGHT);
                    case RIGHT -> state.rotate(BlockRotation.CLOCKWISE_180).with(SHAPE, DeskShape.LEFT);
            ...
            case FRONT_BACK -> {
                ...
                return switch (stairShape) {
                    case LEFT -> state.rotate(BlockRotation.CLOCKWISE_180).with(SHAPE, DeskShape.LEFT);
                    case RIGHT -> state.rotate(BlockRotation.CLOCKWISE_180).with(SHAPE, DeskShape.RIGHT);
                    default -> state.rotate(BlockRotation.CLOCKWISE_180);
                };
            }
        }
