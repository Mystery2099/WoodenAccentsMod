...
class ThinBookshelfBlock(val baseBlock : Block) : ChiseledBookshelfBlock(FabricBlockSettings.copyOf(baseBlock).requires(FeatureFlags.UPDATE_1_20)), GroupedBlock {
    override val itemGroup: ItemGroup
        get() = WoodenAccentsModItemGroups.livingRoomItemGroup
